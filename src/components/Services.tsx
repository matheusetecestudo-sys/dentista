...
const Services = () => {
    return (
        <section className="bg-gray-50 py-20 sm:py-28" id="tratamentos">
                    ...
                    {treatments.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="p-3.5 xs:p-5 md:p-8 flex flex-col flex-grow relative bg-white z-10 -mt-4 rounded-t-3xl transition-transform duration-500">
                                ...
                                <p className="text-[10px] xs:text-xs sm:text-sm text-gray-400 mb-4 sm:mb-6 leading-relaxed flex-grow font-medium line-clamp-3">
                                    {service.description}
                                </p>
                                ...
                                >
                                    ...
                                    <div className="bg-white p-1 sm:p-2 rounded-full shadow-sm group-hover:shadow-md transition-shadow hidden xs:block">
                                        <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 text-[#0A1128] group-hover:text-teal-600 transition-colors" />
                                    </div>
                                </a>
                            </div>
                        </motion.div>
